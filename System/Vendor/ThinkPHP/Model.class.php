...
class Model {
    ...
    protected function _checkTableInfo() {
        ...
        if(empty($this->fields)) {
            // 如果数据表字段没有定义则自动获取
            if($this->C('DB_FIELDS_CACHE')) {
                $db   =  $this->dbName?:$this->C('DB_NAME');
...
//        static $_config = array();
        isset(self::$_conventions[static::class]) or self::checkInitialized(true);
        $_config = &self::$_conventions[static::class];
        //---------------------------------------------//
        // 无参数时获取所有
        if (empty($name)) {
            return $_config;
